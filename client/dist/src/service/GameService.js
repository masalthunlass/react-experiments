...
export var GameService = {
    create: function (id, firstPlayer) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            axios.post('http://localhost:5000/api/games', { id: id, firstPlayer: firstPlayer }).then(function () {
    ...
    fetch: function (id) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            axios.get('http://localhost:5000/api/games/' + id).then(function (_a) {
                var data = _a.data;
